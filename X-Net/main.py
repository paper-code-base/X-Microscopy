...
parser.add_argument('--withbn', dest='withbn', type=str2bool, default=True, help='model with or without fusion')
parser.add_argument('--same_input_size', dest='same_input_size', type=str2bool, default=True, help='mode input with same or different size')
